...
public class ScoreCoralCommand extends BaseCommand {
    ...
    @Inject
    public ScoreCoralCommand (StingerCollectionSubsystem coralScorerSubsystem){
    ...
    public void initialize() {
        coral.setStingerCollectionState(StingerCollectionSubsystem.StingerCollectionState.SCORING_CORAL);
    }
