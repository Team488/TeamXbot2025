package competition.subsystems.drive.akitswerve;
...
import competition.generated.TunerConstants;
...
import static competition.subsystems.drive.akitswerve.PhoenixUtil.tryUntilOk;
...
public class ModuleIOTalonFX implements ModuleIO {
    ...
    public ModuleIOTalonFX(
                ...
                switch (constants.FeedbackSource) {
                    ...
                    default -> throw new RuntimeException(
                            "You are using an unsupported swerve configuration, which this template does not support without manual customization. "
                                    + "The 2025 release of Phoenix supports some swerve configurations which were not available during 2025 beta testing, "
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(
                AkitDrive.ODOMETRY_FREQUENCY, drivePosition, turnPosition);
        BaseStatusSignal.setUpdateFrequencyForAll(
                50.0,
                driveVelocity,
                driveAppliedVolts,
