...
public class ManualSwerveDriveLogic {
    ...
    static final Logger log = LogManager.getLogger(ManualSwerveDriveLogic.class);
    final AKitLogger aKitLog;
    String prefix = "ManualSwerveDriveLogic/";

    @AssistedFactory
    public abstract static class ManualSwerveDriveLogicFactory {
        public abstract ManualSwerveDriveLogic create();
    }

    @AssistedInject
    public ManualSwerveDriveLogic(
            OperatorInterface oi, DriveSubsystem drive, PoseSubsystem pose, PropertyFactory pf,
            HeadingModule.HeadingModuleFactory headingModuleFactory, HumanVsMachineDecider.HumanVsMachineDeciderFactory hvmFactory) {
        pf.setPrefix(prefix);
        this.drive = drive;
        this.pose = pose;
        this.oi = oi;
    ...
    public ManualSwerveDriveAdvice getDriveAdvice() {
        ...
        return new ManualSwerveDriveAdvice(
                translationIntent,
                rotationIntent,
