...
public class PathToFaceAndScoreCommandGroupFactory {
    ...
    PathToReefFaceThenAlignCommandGroupFactory driveToReefFaceThenAlignCommandGroupFactory;
    ...
    @Inject
    public PathToFaceAndScoreCommandGroupFactory(PathToReefFaceThenAlignCommandGroupFactory driveToReefFaceThenAlignCommandGroupFactory,
                                                 PrepCoralSystemCommandGroupFactory prepCoralSystemFactory,
                                                 Provider<ScoreWhenReadyCommand> scoreWhenReadyProvider,
                                                 MeasureDistanceBeforeScoringCommand measureDistanceBeforeScoringCommand) {
