...
public class PathDriveToCoralStationAndIntakeUntilCollected {
    Provider<PathToNearestCoralStationSectionCommand> driveToCoralStationSectionCommandProvider;
    ...
    public ParallelDeadlineGroup create() {
        ...
        PathToNearestCoralStationSectionCommand pathDriveToNearestCoralStationSectionCommand = driveToCoralStationSectionCommandProvider.get();
