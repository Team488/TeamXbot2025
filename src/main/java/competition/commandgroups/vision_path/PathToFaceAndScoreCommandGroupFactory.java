...
public class PathToFaceAndScoreCommandGroupFactory {
    PathToReefFaceAndPrepThenAlignCommandGroupFactory pathToReefFaceAndPrepThenAlignCommandGroupFactory;
    ...
    @Inject
    public PathToFaceAndScoreCommandGroupFactory(PathToReefFaceAndPrepThenAlignCommandGroupFactory pathToReefFaceAndPrepThenAlignCommandGroupFactory,
                                                 Provider<MeasureDistanceBeforeScoringCommand> measureDistanceBeforeScoringCommandProvider,
                                                 PrepCoralSystemCommandGroupFactory prepCoralSystemFactory,
                                                 Provider<ScoreWhenReadyCommand> scoreWhenReadyProvider,
                                                 PropertyFactory pf) {
        this.pathToReefFaceAndPrepThenAlignCommandGroupFactory = pathToReefFaceAndPrepThenAlignCommandGroupFactory;
