...
public class DriveToClosestStationCommandGroupFactory {
    ...
    @Inject
    public DriveToClosestStationCommandGroupFactory(PoseSubsystem poseSubsystem, Provider<DriveToCoralStationInterstitialCommand> driveToCoralStationSectionCommandProv, Provider<AlignToSpecificHumanLoadingStationCommand> alignToCoralStationCommandProv, PrepCoralSystemCommandGroupFactory prepCoralSystemCommandGroupFactory, Provider<IntakeUntilCoralCollectedCommand> intakeUntilCoralCollectedCommandProv, Provider<ShoveCoralStationCommand> shoveCoralStationCommandProv) {
    ...
    public SequentialCommandGroup createDriveOnly(boolean addPoint) {
        ...
        driveToCoralStation.addCommands(new NamedInstantCommand("GetNearestCoralStation", () -> {
    ...
    public ParallelDeadlineGroup createWithIntakeUntilCollected(boolean addPoint) {
