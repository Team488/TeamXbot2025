...
public class RightFourCoralAuto extends BaseAutonomousSequentialCommandGroup {
    ...
    public RightFourCoralAuto(
        ...
        // Score 1
        getDriveAndScoreStatusMessageCommand(Landmarks.ReefFace.FAR_RIGHT, Landmarks.Branch.A, Landmarks.CoralLevel.FOUR);
        ...
        // Coral Station
        var driveToLeftStation = pathDriveToLocationAndIntakeUntilCollectedProvider.get().create(Paths.Side.RIGHT, farLeftBToCoralStationBlue)
                .alongWith(
        ...
        var driveAndScoreCloseLeftBranchBLevelFour = driveToFaceAndScoreFact.create(
                ...
                .alongWith(getDriveAndScoreStatusMessageCommand(Landmarks.ReefFace.CLOSE_RIGHT, Landmarks.Branch.A, Landmarks.CoralLevel.FOUR));
        this.addCommands(driveAndScoreCloseLeftBranchBLevelFour);

        // Coral Station
        var driveToRightStationAndIntakeSecond = pathDriveToLocationAndIntakeUntilCollectedProvider.get().create(Paths.Side.RIGHT, blueCloseLeftBranchBToLeftCoralStation)
                .alongWith(
                        getDriveAndIntakeStatusMessageCommand(Landmarks.CoralStation.RIGHT, Landmarks.CoralStationSection.MID));
        ...
        // Coral Station
        var driveToLeftStationAndIntakeSecond = pathDriveToLocationAndIntakeUntilCollectedProvider.get().create(Paths.Side.RIGHT, blueCloseLeftBranchAToLeftCoralStation)
                .alongWith(
                        getDriveAndIntakeStatusMessageCommand(Landmarks.CoralStation.RIGHT, Landmarks.CoralStationSection.MID));
        ...
        var homed = pathDriveToLocationAndIntakeUntilCollectedProvider.get().create(Paths.Side.RIGHT, blueCloseBranchAToLeftCoralStation)
                .alongWith(
                        getDriveAndIntakeStatusMessageCommand(Landmarks.CoralStation.RIGHT, Landmarks.CoralStationSection.MID));
