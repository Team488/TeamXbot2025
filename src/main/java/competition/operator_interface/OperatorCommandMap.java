...
public class OperatorCommandMap {
    ...
    public void setupDriverCommands(
        ...
        operatorInterface.driverGamepad.getifAvailable(XXboxController.XboxButton.Y).whileTrue(driveToClosestReefSectionWithVisionCommand);
        operatorInterface.driverGamepad.getifAvailable(XXboxController.XboxButton.X).whileTrue(driveToCoralStationWithVisionCommand);
